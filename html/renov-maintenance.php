<section id="ijikanri" class="clearfix anchor">
  ...
  <div class="row">
    <div class="col-sm-6">
      ...
      。 </div>
    <div class="col-sm-6">
      <figure class="w100"> <img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/ijikanri001.webp" alt="建物の維持管理"> </figure>
    </div>
  </div>
</section>
<!--ijikanri-->
...
<section id="tenkenkou" class="clearfix anchor">
  ...
  <div class="row">
    ...
    <div class="col-sm-5">
      <figure class="w100"> <img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/tenkenkou003.webp" alt="天井点検口"> </figure>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-7">
...
<section id="kyuuhaisuikan" class="clearfix anchor">
  ...
  <figure class="w100 maxw-890 mx-auto mb-4"> <img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/kyuuhaisuikan001.webp" alt="排水管のイメージ"> </figure>
  <div class="row">
    <div class="col-sm-7">
