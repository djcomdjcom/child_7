...
<section id="reform-gaiheki_yane" class="anchor">
  ...
  <div class="row">
    <div class="col-sm-7">
      ...
      <p>外壁・屋根塗装を専門とする工事会社もありますが、工務店で外壁塗装をすると、構造体の劣化が会った場合に適切な処置をすることができます。<br>
...
<section id="reform-shoukouji" class="anchor">
  ...
  <hr>
  <h4 class="ttl point"> <span> Point 2 </span> どこに頼んだらいいのか解らない工事もお任せ </h4>
  <p> サッシや建具の建付、戸棚の丁番調整、棚の取付け、コンセントの増設、壁の穴開けなど、ちょっとした改善で日常の暮らしは良くなるのに、どこに頼んだら良いのか分らないと言うような工事<?php echo get_option('profile_shop_name'); ?>にご相談ください。 </p>
  <hr>
  <h4 class="ttl point"> <span> Point 3 </span> 明朗会計 </h4>
  <p> 工事前に分りやすい御見積を提示し、ご承諾頂いてから工事致しますので、工事費用についても安心です。<br>
