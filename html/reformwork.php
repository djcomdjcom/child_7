...
<section id="reform-gaiheki_yane" class="anchor">
  <h2>外壁・屋根塗装</h2>
  <h3 class="ttl my-4">外壁・屋根塗装のメンテナンスも重要です</h3>
  ...
  <div class="row">
    <div class="col-sm-7">
      ...
      <h4 class="brackerts2 ttl">メンテナンスを怠ると・・・</h4>
      <p>建物の外観が美しくなくなる」というみた目だけでなく、</p>
      <ul class="check">
        <li> 外壁・屋根のひびやめくれから雨水が入り込んで壁や柱が腐食する </li>
        <li> 建物の強度が下がって地震や台風への不安が高まる </li>
      </ul>
      <p>建物の寿命が短くなり、生活を脅かす危険性が大きくなってしまいます。 </p>
    </div>
    <div class="col-sm-5">
      <figure class="w100 mx-5"> <img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/reform-gaiheki_yane002@2x.webp"  alt="修理が必要な外壁のイメージ"/> ▲メンテナンス前のひびが入っている外壁 </figure>
    </div>
  </div>
  <div class="row">
    <div class="col-sm-7">
      <h4 class="brackerts2 ttl">工務店で外壁・屋根塗装をすべき理由 </h4>
      <p>外壁・屋根塗装を専門とする工事会社もありますが、工務店で外壁塗装をすると、構造体の劣化があった場合に適切な処置をすることができます。<br>
        私たちは美観もさることながら、建物を長持ちさせることを最優先に外壁・屋根塗装をしています。</p>
      <h4 class="brackerts2 ttl">工事履歴を管理しています</h4>
      <p>私たちは地域密着の工務店です。<br>
        ですから、地域の方々の建物を工事させて頂いた場合は、可能な限り建物の状態を情報として保管しています。<br>
        外壁塗装など足場を使用するような大規模なリフォームの場合は、建物の状態を健全な状態に修繕し、適切に維持メンテナンスできるように工事履歴を管理しています。<br>
        ハウスメーカーや分譲住宅を購入された方でもお問合せください。<br>
        適切なご提案をいたします。</p>
      <p> ※私たちは地域密着工務店として皆様の建物を永続してお守りしていくため、誠実なご対応をお約束します。不要な工事を強要したり強引なセールスなどは決していたしませんので、少しでもご心配ごとがございましたら、まずはご相談ください。</p>
    </div>
    <div class="col-sm-5">
      <figure class="w100 mx-5"> <img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/reform-gaiheki_yane003@2x.webp"  alt="建物の状態を確認"/> ▲可能な限り建物状態を情報として管理しています </figure>
    </div>
  </div>
</section>
<section id="reform-shoukouji" class="anchor">
  ...
  <hr>
  <h4 class="ttl point"> <span> Point 2 </span> どこに頼んだらいいのか分からない工事もお任せ </h4>
  <p> サッシや建具の建付、戸棚の丁番調整、棚の取付け、コンセントの増設、壁の穴開けなど、ちょっとした改善で日常の暮らしは良くなるのに、どこに頼んだら良いのか分らないと言うような工事も<?php echo get_option('profile_shop_name'); ?>にご相談ください。 </p>
  <hr>
  <h4 class="ttl point"> <span> Point 3 </span> 明朗会計 </h4>
  <p> 工事前に分かりやすい御見積を提示し、ご承諾頂いてから工事致しますので、工事費用についても安心です。<br>
    ご提示した御見積金額でご納得いただけない場合は、遠慮なくお断りください。<br>
    現場調査費用など工事前に行なった作業についてご請求することはございません。 </p>
  <hr>
  <h4 class="ttl point"> <span> Point 4 </span> 主にご対応可能な工事 </h4>
  <h5>水廻り・設備</h5>
  <p>給湯器交換 / 水漏れ修理 / 浄水器取付 / 暖房便座 ウォシュレット交換 / 食器洗い乾燥機交換 / 配管交換　など</p>
  <h5>電気工事</h5>
  <p>換気扇交換 / コンセント交換・増設 / 玄関ドアホン交換 / TVアンテナ交換　など</p>
  <h5>屋根・外壁</h5>
  <p>雨樋清掃 / 外壁塗装・コーキング / 雪止め取付 / 鉄部・木部塗装 / モルタル部補修など</p>
  <h5>外回り</h5>
  <p>カーポート修理 / バルコニー修理 / 表札・ポスト交換 / 塀・ポーチ補修 /雨水タンク設置など</p>
  <h5>建具・サッシ</h5>
  <p>玄関ドア修理 / サッシ戸車交換 / 雨戸・網戸修理 / クローザー交換 / ガラス交換※など</p>
  <h5>内装・インテリア</h5>
  <p>床材張替 / カーテン・窓回り / 傷補修 / 襖・障子工事 / 点検口の設置/ハウスクリーニング</p>
  <h5>防犯・安全対策</h5>
  <p>各種鍵交換・取付 / 面格子取付 / 手すり取付 / 滑り止め取付　飛散防止フィルム貼り</p>
  <h5>害虫・害獣駆除</h5>
  <p class="green">記載以外の内容もご相談ください。<br>
    工事内容を確認のうえ、お電話で概算金額をご案内いたします。</p>
  （※は上記とは別の料金体系となります。）
  <hr>
  <h4 class="ttl point"> <span> Point 5 </span> 小工事ご依頼の流れ </h4>
  <p>
  <p> <span class="ttl brown">&#9312;お電話でご相談ください。</span><br>
    お電話でのお問合せ：
    <?php
    ...
    &nbsp;<span class="telnum txt-ll green"><?php echo $profile_inquiry_tel; ?>&nbsp;</span>
    <?php
    endif;
    ?>
    <br>
    ※お名前、ご住所、お電話番号に加えて、現在お困りの状況をお話ください。</p>
  <p> <span class="ttl brown">&#9312; 現地調査日を決定します</span><br>
    工事カ所の調査のためにご都合の良い日程をお聞かせください。</p>
  <p> <span class="ttl brown">&#9314; 工事内容のご提案とお見積書をご提示します。</span><br>
    工事内容と費用について分りやすくお伝えいたします。<br>
    強引な営業などはございません。ご提示した御見積金額でご納得いただけない場合は、遠慮なくお断りください。</p>
  <p> <span class="ttl brown">&#9315; 工事日を確定いたします。</span><br>
    お見積りの内容をご承諾いただけましたら工事日を確定いたします。
  <p> <span class="ttl brown">&#9316; 工事完了とお支払い</span> 工事完了をご承諾いただき、工事完了日に工事代金を現金でお支払い頂きます。<br>
    工事代金が３万円を超える場合は銀行振込をお願いする場合もございます。</p>
  <p> <span class="ttl brown">&#9317; アフターフォロー</span><br>
    工事カ所について万が一不具合がございましたら追加費用無しで手直しいたします。<br>
