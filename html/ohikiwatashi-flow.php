...
<section id="ohikiwatashi-flow02" class="anchor">
  <dl class="flow">
    ...
    <dd class="inbox">
      <div class="row">
        <div class="col-sm-7">
          ...
          <p>近隣の方々への工事のご協力のお願いと工事中にお気づきの点があった場合に、当社へご連絡いただければ真摯にご対応させていただく旨をお伝えいたします。</p>
        </div>
        <div class="col-sm-5">
          <figure class="w100">
      ...
      <div class="row">
        <div class="col-sm-7">
          <p>既存建物の解体までに仮住まいへのお引越しをします。<br>
            仮住まいや家具を保管しておく倉庫探し、お引越し業者の斡旋もお手伝いいたします。</p>
          <p>この時期は断捨離のチャンスでもあります。新居で使う予定のない既存建物の家具や日用品の廃棄に関しましてもご相談ください。</p>
        </div>
        <div class="col-sm-5">
          <figure class="w100">
    ...
    <dd class="inbox">
      <div class="row">
        <div class="col-sm-7">
          ...
          <p>地盤調査と地盤改良の費用は、請負契約の内容に含まれておりますので、追加費用がかかることはほとんどありませんが、地中より土壌汚染や産業廃棄物が見つかった場合は、追加の費用がかかります。</p>
          <p>地盤改良施工した場合は、地盤ネット株式会社と（一社）地盤安心住宅整備支援機構の地盤保証をお付けしております。</p>
        </div>
        <div class="col-sm-5">
          <figure class="w100">
    ...
    <dd class="inbox">
      <div class="row">
        <div class="col-sm-7">
          ...
          <p>第三者機関の検査は瑕疵担保責任保険を受けるためのものでもあります。</p>
          <p>■瑕疵担保責任保険とは<br>
            万が一建物に重大な瑕疵を発見した場合、補修に必要な費用（限度額2,000万円）が保険金として支払われる保険制度です。</p>
        </div>
        <div class="col-sm-5">
          <figure class="w100">
    ...
    <dd class="inbox">
      <div class="row">
        <div class="col-sm-7">
          ...
          <p>上棟の日には上棟式を行なうのが一般的です。</p>
          <p>当社では上棟式の際に、綿密に打ち合わせて決定した設計図書の通りに完成させるとお客様に誓う「宣誓式」を執り行わせていただいております。</p>
          <p>また上棟式では、お食事や飲み物を用意し、上棟を関係者みんなで祝います。<br>
            この頃に、中間金のお支払いがあります。</p>
        </div>
        <div class="col-sm-5">
          <figure class="w100">
    ...
    <dd class="inbox">
      <div class="row">
        <div class="col-sm-7">
          ...
          <p>天井や壁の下地ボードを貼り始めた頃に、構造見学会を開催させていただいております。<br>
            こちらは強制ではございませんが、当社で施工している高性能住宅のことを近隣の皆様や住まいづくりをご検討されている方にも知っていただく機会として、お施主様にお願いしております。当社の家づくりを普及するためにご協力ください。</p>
        </div>
        <div class="col-sm-5">
          <figure class="w100">
    ...
    <dd class="inbox">
      <div class="row">
        <div class="col-sm-7">
          ...
          <p> また、家電や家具などが図面通りに収まるかどうか、新しく購入する予定の家具や家電の搬入経路などを確認します。<br>
      ...
      <div class="row">
        <div class="col-sm-7">
          <p>隣地の方と境界の施工など、ご納得いただいてから外構工事を進めます。<br>
            車庫がガードレールに干渉している場合の行政機関への申請なども行ないます。<br>
            この時期に完成見学会の開催をお願いしています。</p>
          <p>お施主様のご親戚やお友達に新居のお披露目とともに完成した新居の写真撮影をお願いしております。</p>
          <p>また、私たちの家づくりに共感いただけましたら、近隣の皆様や住まいづくりを検討されている方に向けて、<?php echo get_option('profile_shop_name'); ?>の家づくりを見ていただくための完成見学会の開催にご協力ください。</p>
    ...
    <dd class="inbox">
      ...
      <p>■表題登記とは<br>
        一筆の土地または一個の建物に関して、最初になされる表示登記のこと。<br>
        新築された建物などの場合、登記記録そのものが存在していないので、登記記録そのものを新規に作成する手続きが必要になります。<br>
        この場合、新規に登記記録を作成するには手順として、まず表題部を作成する必要があり、このような登記を「表題登記」と呼んでいます。<br>
        建物の新築の場合、表題登記は建築後1ヵ月以内に申請しなければなりません。1ヵ月以内に申請しない場合は過料に処せられます。（ただし、1ヵ月経過後も表題登記の申請はでき、申請義務があります） </p>
      <p>■保存登記とは<br>
        所有権の保存の登記のことで、初めてする所有権の登記のこと。<br>
      ...
      <div class="row">
        <div class="col-sm-7">
          <p>建物に問題がないか完了チェックをお施主様と一緒に行ないます。<br>
            チェックいただいた部分の補修や手直しした箇所の再チェックをいただいたのち、お引き渡し式で鍵と引き渡し図書をお渡しします。設備等の取扱説明書をお渡しして使い方のご説明をいたします。
      ...
      <div class="row">
        <div class="col-sm-7">
          <p>引っ越しは大変な作業ですが、自慢のわが家を自分好みの空間にする時間です。<br>
            住みはじめた時から、長年ずっと住んでいたような家が<?php echo get_option('profile_shop_name'); ?>の家です。<br>
            標準仕様で内装材を免疫処理しています。家の中で深呼吸してください。きれいな空気の住まいに驚かれることでしょう。</p>
      ...
      <div class="row">
        <div class="col-sm-7">
          <p>新居での生活がスタートして自分好みの空間になり始めた頃、お施主様のご意見やご要望をヒアリングにお伺いいたします。<br>
            3か月点検の際には「住まい方勉強会」として、夏季または冬季を迎える前に住み心地をいっそう良くするアドバイスもいたします。</p>
          <p>当社は設計から施工までをワンストップで管理しておりますので、建物の情報はすべて保管しております。<br>
