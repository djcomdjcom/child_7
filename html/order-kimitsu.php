...
<div  class="row">
  ...
  <div class="col-md-6">
    <figure class="w100 pl-md-5"> <img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/kimitsu001@2x.webp" alt="機密C値のイメージ"> </figure>
  </div>
</div>
<div class="col-12">
...
<figure class="w100 maxw-890 mx-auto pl-md-5">
<img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/kimitsu002@2x.webp" alt="機密C値のイメージ">
</section>
<!--kimitsu-cvalue-->
...
<section id="kimitsu-sw" class="clearfix anchor">
  ...
  <figure class="w100 maxw-890 mx-auto pl-md-5"> <img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/kimitsu003@2x.webp" alt="機密 スーパーウォール性能報告書"> ※性能報告書は、住宅の性能値を確認していただくもので、性能を保証するものではありません。 </figure>
  <div class="row">
    ...
    <div class="col-sm-5 col-12 px-5 px-sm-0 px-lg-5">
      <figure class="w100 px-5 px-sm-0 px-lg-5 maxw-400"> <img class="" src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/kimitsu004@2x.webp" alt="スーパーウォール保証書（35年無結露保証）"> </figure>
    </div>
  </div>
</section>
<!--kimitsu-sw-->
