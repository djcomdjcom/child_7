...
<section id="kyuuhaisuikan" class="clearfix anchor">
  ...
  <figure class="w100 maxw-890 mx-auto"> <img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/kyuuhaisuikan001.webp" alt="排水管のイメージ"> </figure>
  <div class="row">
    <div class="col-sm-7">
...
<section id="teikitenken" class="clearfix anchor">
  ...
  <figure class="w100 maxw-890 mx-auto"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/teikitenken.webp" alt="定期点検のイメージ"> </figure>
</section>
<!--teikitenken-->
...
<section id="rirekikanri" class="clearfix anchor">
  ...
  <figure class="w100 maxw-890 mx-auto"> <img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/rirekikanri001.webp" alt="住宅履歴管理"> </figure>
...
<section id="yane_gaiheki" class="clearfix anchor">
  ...
  <figure class="w100 maxw-890 mx-auto"> <img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/yane_gaiheki001.webp" alt="外壁塗装のイメージ"> </figure>
...
<section id="barrierfree" class="clearfix anchor">
  ...
  <figure class="w100 maxw-890 mx-auto"> <img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/barrierfree001.webp" alt="バリアフリーの住宅イメージ"> </figure>
...
<section id="reform" class="clearfix anchor">
  ...
  <figure class="w100 maxw-890 mx-auto"> <img src="<?php bloginfo('stylesheet_directory'); ?>/images/builder/reform001.webp" alt="暮らしを良くするリフォーム"> </figure>
